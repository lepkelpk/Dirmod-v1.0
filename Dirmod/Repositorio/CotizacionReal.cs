...
{
    public class CotizacionReal : ICotizaciones
    {
        public async Task<CotizacionRespuesta> GetCotizacion()
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                // New code:
                HttpResponseMessage response = await client.GetAsync("v1/quotes/BRL/ARS/json?quantity=1&key=2358|6*QEMwV3uJXUHKw5sDe8noXB15cKFeuz");
